...
public class Ex2 extends Basic {

  public static void main(String[] args) {
    Ex2 app = new Ex2( "game", 500, 500, 30 );
    app.start();
  }// main
  ...
  public Ex2( String appTitle, int pw, int ph, int fps )
  {
  ...
  private void setData() {
      ...
      try {
          ...
          for(int i = 0; i < numOfBoxes; i++) {
              ...
              scan.nextLine();
              boxes.add(new Box(x, y, width, heigth, r, g, b));
  ...
  private void create() {
      ...
      //for each square, there are 2 triangles and 3 vertices and each vertex has xyz components
      positionData = new float[numOfBoxes * 2 * 3 * 3];
      //for each square, there are 2 triangles and has rgb components for all 3 vertices
      colorData = new float[numOfBoxes * 2 * 3 * 3];
      for(int i = 0; i < numOfBoxes; i++) {
          Box a = boxes.get(i);
          //triangle 1 vertices
          positionData[18*i+0] = (float)a.x;
          positionData[18*i+1] = (float)a.y;
          positionData[18*i+2] = 0.0f;
          positionData[18*i+3] = (float)(a.x + a.width);
          positionData[18*i+4] = (float)a.y;
          positionData[18*i+5] = 0.0f;
          positionData[18*i+6] = (float)a.x;
          positionData[18*i+7] = (float)(a.y + a.heigth);
          positionData[18*i+8] = 0.0f;
          //triangle 2 vertices
          positionData[18*i+9] = (float)(a.x + a.width);
          positionData[18*i+10] = (float)(a.y + a.heigth);
          positionData[18*i+11] = 0.0f;
          positionData[18*i+12] = (float)(a.x + a.width);
          positionData[18*i+13] = (float)(a.y);
          positionData[18*i+14] = 0.0f;
          positionData[18*i+15] = (float)(a.x);
          positionData[18*i+16] = (float)(a.y + a.heigth);
          positionData[18*i+17] = 0.0f;
          //triangle 1 colors
          colorData[18*i+0] = (float)a.r;
          colorData[18*i+1] = (float)a.g;
          colorData[18*i+2] = (float)a.b;
          colorData[18*i+3] = (float)a.r;
          colorData[18*i+4] = (float)a.g;
          colorData[18*i+5] = (float)a.b;
          colorData[18*i+6] = (float)a.r;
          colorData[18*i+7] = (float)a.g;
          colorData[18*i+8] = (float)a.b;
          //triangle 2 colors
          colorData[18*i+9] = (float)a.r;
          colorData[18*i+10] = (float)a.g;
          colorData[18*i+11] = (float)a.b;
          colorData[18*i+12] = (float)a.r;
          colorData[18*i+13] = (float)a.g;
          colorData[18*i+14] = (float)a.b;
          colorData[18*i+15] = (float)a.r;
          colorData[18*i+16] = (float)a.g;
          colorData[18*i+17] = (float)a.b;
      }
  ...
  protected void processInputs()
  {
    ...
    while( InputInfo.size() > 0 )
    {
                               ...
                               info.action == GLFW_REPEAT) )
      {
		...
		if ( code == GLFW_KEY_LEFT ) {
           positionData[9] -= 0.01;   
           positionData[12] -= 0.01;   
           positionData[15] -= 0.01;   
        }
        else if ( code == GLFW_KEY_RIGHT ) {
           positionData[9] += 0.01;   
           positionData[12] += 0.01;   
           ...
           positionData[10] -= 0.01;   
           positionData[13] -= 0.01;   
           positionData[16] -= 0.01;   
        }
        else if ( code == GLFW_KEY_UP ) {
           positionData[10] += 0.01;   
           positionData[13] += 0.01;   
